...
class Cam (object):
    def __init__(self):
        def gstreamer_pipeline(capture_width=CW, capture_height=CH, framerate=10):
        ...
        # HACK: cam.set(cv2.CAP_PROP_BUFFERSIZE, 0) #Fjerner måske buffer
